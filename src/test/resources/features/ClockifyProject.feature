  ...
  Scenario Outline: Fail Update project on workspace for <reason>
    ...
    * define empty = ""
    ...
    Examples:
      ...
      | empty api-key                                   | 680ab99aaf0c792d89b73fa7 | 690625a4133ebe6373041dee | $(empty)                                         | without changes                            | 401         | Api key does not exist                                                                                                                                                                                                                                                                                   |
      ...
      | empty projectId                                 | 680ab99aaf0c792d89b73fa7 | $(empty)                 | NjliOWFiYmUtMzc2ZC00Zjg2LWJhYzUtNWIzOTE1ZjlkYmIz | without changes                            | 400         | Proyecto no pertenece a Espacio de trabajo                                                                                                                                                                                                                                                               |
